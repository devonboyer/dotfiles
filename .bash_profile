...
alias sshfs-uwaterloo='sshfs d2boyer@linux.student.cs.uwaterloo.ca:/u5/d2boyer ~/uwaterloo'
alias ssh-ubuntu1404='ssh -Y d2boyer@ubuntu1404.student.cs.uwaterloo.ca'
alias sshfs-db2='sshfs d2boyer@ubuntu1604-006.student.cs.uwaterloo.ca:/u5/d2boyer ~/uwaterloo'
